...
public class MediaUploadService {
    ...
    public ResponseResult register(String fileMd5, String fileName, Long fileSize, String
        ...
        LOGGER.info("MD5：" + fileMd5 + ";"+fileName+";"+fileSize+";"+mimetype+";"+fileExt);
    ...
    public CheckChunkResult checkchunk(String fileMd5, Integer chunk, Integer chunkSize) {
        ...
        if(chunkFile.exists()){
            LOGGER.info(fileMd5+"块文件"+chunk+"已存在！");
            return new CheckChunkResult(MediaCode.CHUNK_FILE_EXIST_CHECK,true);
        }else{
            LOGGER.info(fileMd5+"块文件"+chunk+"不存在，需要上传！");
    ...
    public ResponseResult uploadchunk(MultipartFile file, String fileMd5, Integer chunk) {
        ...
        try {
            ...
            e.printStackTrace();
            LOGGER.error("upload chunk file fail:{"+chunk+"}", e.getMessage());
        ...
        LOGGER.info(fileMd5+"块文件"+chunk+"上传成功");
        return new ResponseResult(CommonCode.SUCCESS);
    }
