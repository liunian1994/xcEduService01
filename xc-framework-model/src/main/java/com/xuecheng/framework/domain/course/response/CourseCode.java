...
public enum CourseCode implements ResultCode {
    ...
    COURSE_GET_NOTEXISTS(false,31006,"课程信息不存在!"),
    COURSE_PUBLISH_CREATE_INDEX_ERROR(false,31007,"创建课程索引信息失败!"),
    COURSE_MEDIA_TEACHPLAN_ISNULL(false,31008,"课程计划为空！"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false,31009,"只允许为叶子结点课程计划选择视频!"),
